...
class Gestionar_Registros_Widget extends StatefulWidget {
  final Function(Usuario) onGuardar;
  final Usuario usuario;

  const Gestionar_Registros_Widget({
    super.key,
  ...
  @override
  State<Gestionar_Registros_Widget> createState() => Gestionar_Registros_Widget_State();
}

class Gestionar_Registros_Widget_State extends State<Gestionar_Registros_Widget> {
  ...
  @override
  void didUpdateWidget(covariant Gestionar_Registros_Widget oldWidget) {
